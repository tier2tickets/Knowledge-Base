...
Refers to the hostname of the computer from which the end-user submitted the ticket

*email*
"""""""

Refers to the email address the end-user entered to submit the ticket

*name*
""""""

Refers to the end-user's name. This may be the name they entered into the input field or what the ticket system says is the name for that email address


*ip*
""""

Refers to the IP address of the computer from which the end-user submitted the ticket

*mac*
"""""

Refers to the MAC address of the computer from which the end-user submitted the ticket

*message*
"""""""""

Refers to the message which the end-user typed to generate this ticket
...
Refers to some text that will be appended to the message. This typically will have been generated by a :ref:`custom script <content/customization/custom-scripts:_append.txt>`
